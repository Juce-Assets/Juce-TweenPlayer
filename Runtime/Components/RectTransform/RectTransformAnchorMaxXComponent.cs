...
{
    [TweenPlayerComponent("RectTransform Anchor Max X", "RectTransform/Anchor Max X Y/X")]
    [TweenPlayerComponentColor(0.19f, 0.81f, 0.34f)]
    [TweenPlayerComponentDocumentation("The normalized position X in the parent RectTransform that " +
    ...
    public class RectTransformAnchorMaxXComponent : AnimationTweenPlayerComponent
    {
        ...
        protected override ComponentExecutionResult OnExecute(ISequenceTween sequenceTween)
        {
            ...
            ITween progressTween = targetValue.TweenAnchorMaxX(valueValue, durationValue);
