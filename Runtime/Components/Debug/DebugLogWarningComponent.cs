...
{
    [TweenPlayerComponent("Debug Log Warning", "Debug/Log Warning")]
    [TweenPlayerComponentColor(0.5f, 0.192f, 0.721f, useAsBackground: true)]
    [System.Serializable]
    public class DebugLogWarningComponent : AnimationTweenPlayerComponent
    {
        ...
        protected override ComponentExecutionResult OnExecute(ISequenceTween sequenceTween)
        {
            ...
            sequenceTween.AppendCallback(
                () =>
                {
                    UnityEngine.Debug.LogWarning(logValue);
                });
