...
{
    [TweenPlayerComponent("Transform Local Rotation Y", "Transform/Local Rotation X Y Z/Y")]
    [TweenPlayerComponentColor(1f, 0.368f, 0.066f)]
    [TweenPlayerComponentDocumentation("Animates the local rotation Y of a Transform.")]
    [System.Serializable]
    public class TransformLocalRotationYComponent : AnimationTweenPlayerComponent
    {
        ...
        protected override ComponentExecutionResult OnExecute(ISequenceTween sequenceTween)
        {
            ...
            ITween progressTween = targetValue.TweenLocalRotationY(
                valueValue,
                durationValue,
                modeValue
                );
