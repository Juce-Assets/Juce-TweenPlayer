...
{
    [TweenPlayerComponent("Transform Position Z", "Transform/Position X Y Z/Z")]
    [TweenPlayerComponentColor(1f, 0.368f, 0.066f)]
    [TweenPlayerComponentDocumentation("Animates the position Z of a Transform.")]
    [System.Serializable]
    public class TransformPositionZComponent : AnimationTweenPlayerComponent
    {
        ...
        protected override ComponentExecutionResult OnExecute(ISequenceTween sequenceTween)
        {
            ...
            ITween progressTween = targetValue.TweenPositionZ(valueValue, durationValue);
