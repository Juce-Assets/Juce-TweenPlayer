...
{
    [TweenPlayerComponent("TextMeshPro Alpha", "TextMeshPro/Alpha")]
    [TweenPlayerComponentColor(0.5f, 0.468f, 0.266f)]
    [TweenPlayerComponentDocumentation("Changes the color alpha value of a TextMeshPro component.")]
    [System.Serializable]
    public class TextMeshProAlphaComponent : AnimationTweenPlayerComponent
    {
