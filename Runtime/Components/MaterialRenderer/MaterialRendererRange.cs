...
{
    [TweenPlayerComponent("Material Renderer Range", "MaterialRenderer/Range")]
    [TweenPlayerComponentColor(0.835f, 0.878f, 0.294f)]
    [TweenPlayerComponentDocumentation("Changes a Range material property of a Material Renderer.")]
    [System.Serializable]
    public class MaterialRendererRange : AnimationTweenPlayerComponent
    {
        ...
        public override void Validate(ValidationBuilder validationBuilder)
        {
            ...
            if (!target.WantsToBeBinded && !materialIndex.WantsToBeBinded && !materialProperty.WantsToBeBinded)
            {
                ...
                MaterialRendererUtils.Validate(
                    ...
                    UnityEditor.ShaderUtil.ShaderPropertyType.Range,
                    validationBuilder
                    );
            }
